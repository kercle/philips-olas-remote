...
//         , radio(&radio_module)
//         , impl(radio_module, radio, &RadioTransmitter<PIN_CS, PIN_GDO0, PIN_GDO2>::test_isr_handler)
//     // , impl(radio_module, radio, test_isr_handler)
//     {
//     }

//     static void IRAM_ATTR test_isr_handler();
...
// template <uint8_t PIN_CS, uint8_t PIN_GDO0, uint8_t PIN_GDO2>
// void IRAM_ATTR __attribute__((noinline, used))
// RadioTransmitter<PIN_CS, PIN_GDO0, PIN_GDO2>::test_isr_handler()
// {
